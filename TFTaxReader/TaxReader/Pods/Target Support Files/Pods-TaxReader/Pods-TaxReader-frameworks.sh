...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BTCaptchaView/BTCaptchaView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZZCryptManager/ZZCryptManager.framework"
fi
