//
//  TRInlandAddressPickerPresentAnimated.swift
//  TaxReader
//
...
class TRInlandAddressPickerPresentAnimated: NSObject,UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        case .dismiss:
            guard let toVC: TRAreaInlandViewController = transitionContext.viewController(forKey: .from) as? TRAreaInlandViewController else {
                return
            }
