...
typealias TRInfoBirthdayViewBirthdayCoverTap = (_ sender: UITapGestureRecognizer) ->Void

class TRInfoBirthdayView: UIView {
    
    var birthdayCoverTap : TRInfoBirthdayViewBirthdayCoverTap?
    ...
    lazy var trInterImageView: UIImageView = {
        ...
        view.backgroundColor = UIColor.white
        view.image = UIImage.init(named: "日历")
        
        return view
    }()
    
    lazy var trBirthdatLabel: UILabel = {
        let view = UILabel.init()
        view.backgroundColor = UIColor.white
        view.text = "请输入出生日期"
        view.textColor = UIColor.lightGray
    ...
    @objc func infoAreaCoverTap(sender: UITapGestureRecognizer) {
        guard let birthdayCoverTap = birthdayCoverTap else { return }
        birthdayCoverTap(sender)
    }
    ...
    func setupLayout() {
        ...
        self.backView.addSubview(self.trBirthdatLabel)
        self.trBirthdatLabel.snp.makeConstraints { (make) in
        ...
        self.coverView.snp.makeConstraints { (make) in
            ...
            make.leading.equalTo(self.trBirthdatLabel.snp.leading)
        }
    }
