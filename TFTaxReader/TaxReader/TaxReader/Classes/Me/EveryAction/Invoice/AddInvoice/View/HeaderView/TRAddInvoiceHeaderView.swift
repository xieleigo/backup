...
typealias TRAddInvoiceHeaderViewButtonClick = (_ button: UIButton) ->Void

class TRAddInvoiceHeaderView: UIView {
    
    var footerButtonClick : TRAddInvoiceHeaderViewButtonClick?
