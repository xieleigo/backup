//
//  TRLAreaForeignViewController.swift
//  TaxReader
//
...
typealias TRLAreaForeignVCBackVlaueBlock = (_ fullAddress: String, _ areaTreePath: String) ->Void

class TRLAreaForeignViewController: UIViewController {
    
    var foreignBackValueblock : TRLAreaForeignVCBackVlaueBlock?
...
extension TRLAreaForeignViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        guard let foreignBackValueblock = foreignBackValueblock else { return }
        foreignBackValueblock("国外","00-0000")
    }
}
