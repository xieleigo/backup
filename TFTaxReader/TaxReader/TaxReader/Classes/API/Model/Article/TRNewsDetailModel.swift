...
struct TRNewsDetailModel: HandyJSON {
    var ret: Bool = false
    var msgCode: Int = 0
    var msg: String?
    var data: TRNewsDetailDataModel?
}

struct TRNewsDetailDataModel: HandyJSON {
    var News_Title: String?
    var News_Content_HTML: String?
}
