//
//  TRBuyActionContentBenView.swift
//  TaxReader
//
...
typealias TRBuyActionContentBenViewBlock = (_ button: UIButton) ->Void

class TRBuyActionContentBenView: UIView {
    
    var buttonClickBlock: TRBuyActionContentBenViewBlock?
    
    var benModel: TRProductGetIssueNumberDataCurrentModel?
...
//        buttonClickBlock(button)
    ...
    var currentModel: TRProductGetIssueNumberDataCurrentModel? {
        didSet {
            ...
            self.trYearNumberLabel.text = "\(model.ProdYear)年 第\(model.ProdIssue)期"
...
extension TRBuyActionContentBenView {
    func buttonClickReduceNumber(button: UIButton) {
        ...
        self.trPriceLabel.text = "￥ \(self.benModel!.ProdIOSPrice * currentNumber)"
    }
