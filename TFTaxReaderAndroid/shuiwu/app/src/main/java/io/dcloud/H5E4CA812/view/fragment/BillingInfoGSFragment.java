...
import io.dcloud.H5E4CA812.view.adapter.BillingInformationGsAdapter;
 ...
 * 开票信息公司
 */
public class BillingInfoGSFragment extends BaseFragment {
    @BindView(R.id.recyclerview_billing)
    RecyclerView recyclerview_billing;
    BillingInformationGsAdapter adapter;
    private List<BillingInfoItmeBean> mDataList;
    private Context context;

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_billing_info_gs, container, false);
    ...
    public BillingInfoGSFragment(List mPseronDataList) {
        this.mDataList = mPseronDataList;
    }

    public BillingInformationGsAdapter getAdapter() {
        return adapter;
    }

    private void initData() {
        adapter = new BillingInformationGsAdapter(mDataList, context);
