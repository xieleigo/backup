...
public class AllOrderAllTypeFragment extends BaseFragment {
    @BindView(R.id.all_alltype_order_recycler)
    RecyclerView all_alltype_order_recycler;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_allorder_alltype, container, false);
    ...
    private void initView() {
        ...
        all_alltype_order_recycler.setLayoutManager(new LinearLayoutManager(getContext()));
        all_alltype_order_recycler.setAdapter(mLoadMoreWrapper);

        all_alltype_order_recycler.addOnScrollListener(new OnScrollListener() {
            @Override
    ...
    public void onResponse(Request req) {
        ...
        Gson gson = new Gson();
        if (req.getData() != null) {
            if (req.getData().getUrl().contains("/Order/FindDetail")) {//获取默认地址
