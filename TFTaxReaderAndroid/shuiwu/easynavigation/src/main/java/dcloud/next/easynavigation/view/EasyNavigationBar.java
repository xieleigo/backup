package dcloud.next.easynavigation.view;
...
import dcloud.next.easynavigation.adapter.ViewPagerAdapter;
import dcloud.next.easynavigation.constant.Anim;
import dcloud.next.easynavigation.utils.NavigationUtil;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    //选中字体颜色
    private int selectTextColor = Color.parseColor("#6c79ff");
    //分割线高度
